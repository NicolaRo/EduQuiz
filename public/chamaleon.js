...
animationContainer.setAttribute(
  "class",
  isMacLike ? "default_hidden" : "mac_hidden"
);
var animData = {
...
function addMouthProperties() {
  ...
  animationAPI.addValueCallback(
    keyPathMouthContainerTimeRemap,
...
function addArrowProperties() {
  ...
  var rotationPath =
    "Mouth,Tongue_Comp,arrow,Contents,Shape 1,Transform,Rotation";
  var scaleKeyPath, rotationKeyPath;
  if (isMacLike) {
    scaleKeyPath =
      "Mouth,Tongue_Comp,.mac_arrow,Contents,Shape 1,Transform,Scale";
    rotationKeyPath =
      "Mouth,Tongue_Comp,.mac_arrow,Contents,Shape 1,Transform,Rotation";
  } else {
    scaleKeyPath =
      "Mouth,Tongue_Comp,.default_arrow,Contents,Shape 1,Transform,Scale";
    rotationKeyPath =
      "Mouth,Tongue_Comp,.default_arrow,Contents,Shape 1,Transform,Rotation";
  }
  var keyPathArrowScale = animationAPI.getKeyPath(scaleKeyPath);
  var currentScale = -1;
  ...
  var keyPathArrowRotation = animationAPI.getKeyPath(rotationKeyPath);
...
function addTongueProperties() {
  ...
  animationAPI.addValueCallback(
    keyPathTongueContainerTimeRemap,
    function (currentValue) {
      if (
      ...
      if (isActive) {
        tongueCurrentTime =
          (2 * (Date.now() - tongueInitialAnimationTime)) / 1000;
      }
